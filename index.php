        ...
        <a class="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
         ...
         <ul id="nav" class="nav">
           ...
           <li><a class="smoothscroll" href="#resume">Resume</a></li>
            <li><a class="smoothscroll" href="#portfolio">TPs Projects</a></li>
            <li><a class="smoothscroll" href="#testimonials">Positivity</a></li>
         </ul> <!-- end #nav -->
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="three columns">
            ...
            <img class="profile-pic"  src="me.jpg" alt="" />
   ...
   <section id="portfolio">
      ...
      <div class="row">
         ...
         <div class="twelve columns collapsed">
            ...
            <h1 style="font-size:25px;color:#231D1D;">-TP Projects-</h1>
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>If you set your goals ridiculously high and it's a failure, you will fail above everyone else's success
                           </p>
                     ...
                     <li>
                        <blockquote>
                           <p>If you look at what you have in life, you'll always have more. If you look at what you don't have in life, you'll never have enough
                           </p>
                           <cite>Oprah Winfrey</cite>
                        </blockquote>
                     </li>
                        <blockquote>
                           <p>If life were predictable it would cease to be life, and be without flavor.
                           </p>
